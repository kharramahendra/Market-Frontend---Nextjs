...
const Post = ({ post }) => {
    ...
    return (<>
        ...
        <body>
            ...
            <div class="h-[30vh] md:[50vh] lg:[70vh] max-h-screen"><iframe width="100%" height="100%" class="w-full min-h-full" src="https://www.youtube.com/embed/zMZ6IBCQCm8" frameborder="0" allowfullscreen="allowfullscreen"></iframe></div>
