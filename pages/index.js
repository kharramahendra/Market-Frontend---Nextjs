      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-10 md:py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-2">
            ...
            {prices.map((price) => {
              return <a  href={`/post/${price.slug}`} className="cursor-pointer p-2 lg:w-1/3 md:w-1/2 w-full"><div key={price._id} className=" cursor-pointer p-2 lg:w-1/3 md:w-1/2 w-full">
