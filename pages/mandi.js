...
const Mandi = ({ prices }) => {
  ...
  return (
    <>
      ...
      <iframe id="cphBody_iframeDB" className='w-full h-[300px]' height={100} src="https://agmarknet.gov.in/MarketWiseGraph/MarkArrivalGrp.aspx" frameborder="0" scrolling=""></iframe>
      {/* </div>  */}
      {/* <div className='h-[50vh]'> */}
