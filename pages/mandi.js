              ...
              return <Link key={price._id} href={`/post/${price.slug}`}><div className="p-2 lg:w-1/3 md:w-1/2 w-full">
                <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                  ...
                  <div className="flex-grow">
                    <h2 className="text-gray-900 title-font font-medium">{price.timestamp}</h2>
                    <div class="flex space-x-2 justify-center">
                    <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded">{price.keywords[0]}</span>
                      ...
                      <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-green-500 text-white rounded">{price.keywords[1]}</span>
                      ...
                      <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-yellow-500 text-white rounded">{price.keywords[2]}</span>
