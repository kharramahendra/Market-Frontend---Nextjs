                ...
                return <a  href={`/post/${price.slug}`} className="cursor-pointer p-2 lg:w-1/3 md:w-1/2 w-full"><div key={price._id} className="">
                  <div className="h-full flex items-center bg-gray-100 border-2 border-black p-4 rounded-md">
                    ...
                    <div className="flex-grow">
                      ...
                      <div class="flex">
                        <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-pink-800 text-white rounded">{price.keywords[0]}</span>
                        ...
                        <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-gray-800 text-white rounded">{price.keywords[1]}</span>
                        ...
                        <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-pink-800 text-white rounded">{price.keywords[2]}</span>
