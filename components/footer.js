                        ...
                        <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                            ...
                            {news && news.map((post) => {
                                return <div key={post._id} class="mb-7 mx-2 bg-white  sm:mx-auto w-full md:w-2/5 rounded-sm shadow-lg flex card text-grey-darkest">
                                    {post.image != null && <img class="w-1/2 h-4/5 m-1 object-cover object-center rounded-sm" src={process.env.NEXT_PUBLIC_HOST + post.image} alt="tech" />}
                                    {post.image == null && post.image_url != '' && <img class="w-1/2 h-4/5 object-cover object-center rounded-l-sm" src={post.image_url} alt="tech" />}
